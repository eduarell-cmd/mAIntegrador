...
export default function Profile() {
  ...
  const obtenerPromedio = async () => {
    try {
      ...
      const res = await fetch(`https://1a0f5b29f58b.ngrok-free.app/promedioemocion/${userId}`);
  ...
  const obtenerConsejosHoy = async () => {
    try {
      ...
      const res = await fetch(`https://1a0f5b29f58b.ngrok-free.app/consejos_hoy/${userId}`);
  ...
  const obtenerEmociones = async () => {
    try {
      ...
      const res = await fetch("https://1a0f5b29f58b.ngrok-free.app/pruebaemocion", {
        method: "POST",
  ...
  const obtenerTracker = async () => {
    try {
      ...
      const res = await fetch(`https://1a0f5b29f58b.ngrok-free.app/tracker/${userId}`);
      const data = await res.json();
  ...
  const obtenerSemanales = async () => {
    try {
      ...
      const res = await fetch(`https://1a0f5b29f58b.ngrok-free.app/weekly_emotions/${userId}`);
  ...
  const handleLogout = async () => {
    ...
    if (token) {
      try {
        ...
        await fetch('https://1a0f5b29f58b.ngrok-free.app/auth/logout', { // ✅ URL con prefijo /auth
          method: 'POST',
          headers: {
  ...
  const actualizarPerfil = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://1a0f5b29f58b.ngrok-free.app/profile/${user._id}`, {
        method: 'PUT',
        headers: {
